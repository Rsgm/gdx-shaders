...
public class ShaderManager {
	...
	public static final String SHADER_CLASSPATH = "gdx-shaders/gdx-shaders/src/" + "com/thesecretpie/shader/shaders"; // added gdx-shaders/src/ to work with the project layout
